...
func TestMain(m *testing.M) {
	...
	flag.StringVar(&test.oauthClient, "oauth-client", "rai-sdk-go", "test OAuth client name")
	flag.StringVar(&test.userEmail, "user-email", "rai-sdk-go@relational.ai", "test user name")
